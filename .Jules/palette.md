...
**Learning:** The 'STOP' button immediately killed the app/stream without confirmation, which is a high-risk destructive action for a streaming utility.
**Action:** Always wrap application-exit or stream-termination actions in a confirmation dialog (AlertDialog) to prevent accidental disruptions.
